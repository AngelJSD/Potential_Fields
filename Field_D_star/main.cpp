...
void display_callback(){
    ...
    GLfloat ctrlpoints[dStarLite.path.size()][3];
    for(int i=0; i<dStarLite.path.size(); i+=1){
        ctrlpoints[i][0] = dStarLite.path[i]->j+0.5;
        ctrlpoints[i][1] = (COLUMNS-1)-dStarLite.path[i]->i+0.5;
        ctrlpoints[i][2] = 0;
        /*ctrlpoints[i*4+1][0] = dStarLite.path[i]->j+1.0;
        ctrlpoints[i*4+1][1] = (COLUMNS-1)-dStarLite.path[i]->i;
        ctrlpoints[i*4+1][2] = 0;
        ctrlpoints[i*4+2][0] = dStarLite.path[i]->j+1.0;
        ctrlpoints[i*4+2][1] = (COLUMNS-1)-dStarLite.path[i]->i+1.0;
        ctrlpoints[i*4+2][2] = 0;
        ctrlpoints[i*4+3][0] = dStarLite.path[i]->j;
        ctrlpoints[i*4+3][1] = (COLUMNS-1)-dStarLite.path[i]->i+1.0;
        ctrlpoints[i*4+3][2] = 0;*/
        //cout<<"DONE "<<i<<" "<<dStarLite.path.size()*4<<endl;
    }
    /*for(int i=0; i<(int)dStarLite.path.size()-3; i+=3){
