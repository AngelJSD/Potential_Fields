...
cRobot curiosity(0,0);
cGoal goal(1,50,2,2,1);
...
void PintarEscena() {
   ...
   glColor3f(0.1f,0.0f,1.0f);
      ...
      for(int i =0; i<puntos.size(); i++)
	{
		...
		//cout<<" Robot :  "<<puntos[i].first<<" , "<<puntos[i].second<<endl;
               //Pintar(puntos[i].first,puntos[i].second);
...
int main(int argc, char **argv)
{
   ...
   if(uno-otro>0.000009){
	...
	cout<<endl;
	  ...
	  maxx=puntos[0].first;
	  minx=puntos[0].first;
	  maxy=puntos[0].second;
	  miny=puntos[0].second;
	  R=G=B=0.1f;
	  for(int i =1; i<puntos.size(); i++)
	  {
		if(puntos[i].first>maxx)maxx=puntos[i].first;////x
		if(puntos[i].first<minx)minx=puntos[i].first;////x
		if(puntos[i].second>maxy)maxy=puntos[i].second;///y
		if(puntos[i].second<miny)miny=puntos[i].second;///y
	  } 
          for(int i =0; i<mapa.size(); i++)
	  {
		if(mapa[i].first+radios[i].first+radios[i].second>maxx)maxx=mapa[i].first+radios[i].first+radios[i].second;////x
		if(mapa[i].first-radios[i].first-radios[i].second<minx)minx=mapa[i].first-radios[i].first-radios[i].second;////x
		if(mapa[i].second+radios[i].first+radios[i].second>maxy)maxy=mapa[i].second+radios[i].first+radios[i].second;///y
		if(mapa[i].second-radios[i].first-radios[i].second<miny)miny=mapa[i].second-radios[i].first-radios[i].second;///y
	  } 
          for(int i =0; i<meta.size(); i++)
	  {
                if(meta[i].first+meta_radios[i].first+meta_radios[i].second>maxx)maxx=meta[i].first+meta_radios[i].first+meta_radios[i].second;////x
		if(meta[i].first-meta_radios[i].first-meta_radios[i].second<minx)minx=meta[i].first-meta_radios[i].first-meta_radios[i].second;////x
		if(meta[i].second+meta_radios[i].first+meta_radios[i].second>maxy)maxy=meta[i].second+meta_radios[i].first+meta_radios[i].second;///y
		if(meta[i].second-meta_radios[i].first-meta_radios[i].second<miny)miny=meta[i].second-meta_radios[i].first-meta_radios[i].second;///y
	  }
	  maxx++;maxy++;minx--;miny--;
